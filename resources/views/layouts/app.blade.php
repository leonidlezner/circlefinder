            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        <li><a class="nav-link" href="{{ route('circles.index') }}"><span class="fa fa-search mr-1"></span>{{ __('Find circle') }}</a></li>
                        <li><a class="nav-link" href="{{ route('circles.create') }}"><span class="fa fa-plus-circle mr-1"></span>{{ __('Start circle') }}</a></li>
